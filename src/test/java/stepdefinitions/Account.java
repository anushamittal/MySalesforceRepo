...
public class Account {
   ...
   /* @Given("^I open up salesforce to create new account for CPL$")
    public void I_open_up_salesforce_to_create_new_account_for_CPL(String strr) throws Throwable {
        CampaignPage log= page(CampaignPage.class);
        CampaignPage page = open("https://login.salesforce.com/", CampaignPage.class);
        log.loginAsUser(strr);*/
